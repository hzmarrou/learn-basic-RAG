...
Use the [included practice lab](./lab.md) to apply the content you've learned. Follow the steps to create your own repository and apply the requirements to complete the lab.